...
ALTER TABLE MEMBER_1151 ADD PRIMARY KEY(MEMBER_ID);
ALTER TABLE MEMBER_1151 ADD CHECK(MEMBERSHIP_TYPE IN('LIFETIME', 'ANNUAL', 'HALF_YEARLY', 'QUATERLY'));
...
ALTER TABLE BOOKS_1151 MODIFY BOOK_NAME VARCHAR2(30) NOT NULL;
...
ALTER TABLE ISSUE_1151 ADD FOREIGN KEY(BOOK_NO) REFERENCES BOOKS_1151(BOOK_NO);
ALTER TABLE ISSUE_1151 ADD FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER_1151(MEMBER_ID);
...
INSERT INTO MEMBER_1151 VALUES(7,'SURANJAN BASU', 'PURULIA', '30-JUNE-11', 'ANNUAL', 1400, 3, 50);
INSERT INTO MEMBER_1151 VALUES(8,'ARPITA ROY', 'KOLKATA', '31-JULY-11', 'HALF_YEARLY', 700, 1, 0);

SELECT * FROM MEMBER_1151;
...
INSERT INTO ISSUE_1151 VALUES(7003, 104, 1, '1-FEB-11', NULL);
...
INSERT INTO ISSUE_1151 VALUES(7007, 101, 8, '1-AUG-11', NULL);


SELECT * FROM ISSUE_1151;
